      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><Img class="img-thumbnail-type" src ="{{ Storage::url($categorie->image_url) }}"
                  alt = "{{ $categorie->name }}"></td>
            <td><a class="btn btn-danger btn-sm" href="{{ route('categorie-delete',['id' => $categorie->id]) }}"  onclick="confirm('Are you sure, you want to delete it?')">Supprimer</a></td>
          @endforeach
          <tr>
        </tbody>
      </table>
